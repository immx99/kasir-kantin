<?php
    ...
    "('http://src.great-site.net/kasir','$now','$location','$clientIP','')";
    // echo $insert;
    $conn->query($insert);  
    $conn->close();
...
$queryback="SELECT * FROM data where aplikasi= 'kasir'";
...
<body>
  ...
  <div class="container-login100" style="background-image: url('page/images/krincing.jpg');">
    <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
      <form action="op.php" method="post" class="login100-form validate-form">
        ...
        <span class="login100-form-title p-b-37">
          <b>Kasi</b>S</a>
          <p class="login-box-msg"> Cashier Management System<br/>Copyright © 2019 ISWares. ImmSys</p>
        </span>
