    ...
    <?php
       ...
       if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $result=mysqli_query($conn,$sql);
              ...
              if((($tipeavatar == "image/jpeg" || $tipeavatar == "image/png") && ($ukuranavatar <= 10000000 && $username != null)) && ($chmod >= 3 || $_SESSION['jabatan'] == 'admin' || $_SESSION['jabatan'] == 'user'  )){
              ...
              }else if($chmod >= 3 || $_SESSION['jabatan'] == 'admin' || $_SESSION['jabatan'] == 'user'  ){
      ...
      <input type="hidden" name="hapusberhasil" value="3" />
          ...
          else if((($tipeavatar == "image/jpeg" || $tipeavatar == "image/png") && ($ukuranavatar <= 10000000 && $username != null && $password != null && $nama != null)) && ( $chmod >= 2 || $_SESSION['jabatan'] == 'admin' || $_SESSION['jabatan'] == 'user'  )){
               move_uploaded_file($tmp, $avatar);
...
<?php if($_SESSION['jabatan'] == 'admin' || $_SESSION['jabatan'] == 'user'  ){ ?>
      <div class="row">
             <div class="form-group col-md-12 col-xs-12" >
