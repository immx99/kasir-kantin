...
<!-- BOX HAPUS BERHASIL -->
 ...
 window.setTimeout(function() {
    $("#myAlert").fadeTo(500, 0).slideUp(1000, function(){
       ...
       <!-- BOX INFORMASI -->
    <?php
if ($chmod == '1' || $chmod == '2' || $chmod == '3' || $chmod == '4' || $chmod == '5' || $_SESSION['jabatan'] == 'admin' || $_SESSION['jabatan'] == 'user'   || $_SESSION['jabatan'] == 'user'  ) {
} else {
?>
...
<?php
if ($chmod >= 1 || $_SESSION['jabatan'] == 'admin' || $_SESSION['jabatan'] == 'user'   || $_SESSION['jabatan'] == 'user'  ) {
?>
